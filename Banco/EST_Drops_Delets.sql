...
DELETE FROM tbl_orcamento WHERE id_orc = 1;
DELETE FROM tbl_orcamento WHERE id_orc <> 0;


DELETE FROM tbl_orccon WHERE id_orc = 1;
DELETE FROM tbl_orccon WHERE id_orc <> 0;


DELETE FROM tbl_sessao WHERE id_sessao = 1;
DELETE FROM tbl_sessao WHERE id_sessao <> 0;


DELETE FROM tbl_sescon WHERE id_orc = 1;
DELETE FROM tbl_sescon WHERE id_orc <> 0;
#--------------------------------------------------------------------------------------